sap.ui.define([
	...
	return {
		...
		parameterModel: function() {
			...
			sSelectParameters += ",Reviews/ChangedAt,Reviews/Comment,Reviews/HelpfulCount,Reviews/HelpfulForCurrentUser";
			sSelectParameters += ",Reviews/IsReviewOfCurrentUser,Reviews/ProductId,Reviews/Rating,Reviews/UserDisplayName";
